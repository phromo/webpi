...
when "x86_64"
  ...
  default['webpi']['msi'] = "https://download.microsoft.com/download/C/F/F/CFF3A0B8-99D4-41A2-AE1A-496C08BEB904/WebPlatformInstaller_amd64_en-US.msi"
when /i[3-6]86/
  default['webpi']['msi_checksum'] = '4277d5f72f60dfda6d5c8f750f99fe963e0ed44add73e7440fda1bc05b510d25'
  default['webpi']['msi'] = "https://download.microsoft.com/download/C/F/F/CFF3A0B8-99D4-41A2-AE1A-496C08BEB904/WebPlatformInstaller_x86_en-US.msi"
end

default['webpi']['msi_package_name'] = "Microsoft Web Platform Installer 5.0"

default['webpi']['url']       = ''
default['webpi']['checksum']  = ''
